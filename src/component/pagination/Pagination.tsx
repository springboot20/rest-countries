    ...
    <div className='z-40 fixed bottom-7 left-2/4 rounded-lg bg-white shadow-md dark:bg-dark-blue-dark-DME mx-auto -translate-x-2/4'>
      <div className='flex items-center lg:px-4 py-2 rounded-md gap-[0.15rem] lg:gap-4'>
        <Button
          ...
          className={
            'flex items-center gap-5 border-r-[1px] border-gray-900/75 p-2 cursor-pointer'
          }>
          <Icon
            icon={faArrowLeft}
            className={'h-6 text-dark-blue-dark-LMT hidden md:block dark:text-white'}
          />
        ...
        <Button
          onClick={() => handlePageChange(currentPage + 1)}
          className={
            'flex items-center gap-3 border-l-[1px] border-gray-900/75 p-2 cursor-pointer'
          }>
          <span className='text-md md:text-xl font-semibold block dark:text-white'>Next</span>
          <Icon
            icon={faArrowRight}
            className={'h-6 text-dark-blue-dark-LMT dark:text-white hidden md:block'}
          />
        </Button>
      </div>
    </div>
